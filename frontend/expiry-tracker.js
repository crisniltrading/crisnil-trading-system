...
async function loadExpiryDashboard() {
    try {
        ...
        showToast('Failed to load expiry dashboard: ' + error.message, 'error');
    }
}
            ...
            <div class="expiry-product-card ${statusClass}">
                ...
                <div class="product-info-expiry">
                    ...
                    <p class="expiry-date">
                        ...
                        Expires: ${new Date(product.nearestExpiry.expiryDate).toLocaleDateString()}
                    </p>
                    <p class="batch-info">
                        Batch: ${product.nearestExpiry.batchNumber || 'N/A'} 
                        (${product.nearestExpiry.quantity} units)
                    </p>
                </div>
...
function initializeExpiryTracker() {
    ...
    // Load expiry tracker if on that page
    if (document.getElementById('expiryDashboardContainer')) {
        loadExpiryDashboard();
    }
