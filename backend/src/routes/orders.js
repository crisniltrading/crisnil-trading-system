...
router.post('/', async (req, res) => {
  try {
    const { items, paymentMethod, paymentReference, paymentProofUrl, deliveryDate, address, phone, notes, subtotal: clientSubtotal, totalDiscount: clientDiscount, totalAmount: clientTotal } = req.body;
